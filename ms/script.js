...
function LoadMyPlayers() {
  $(document).ready(function() {
    ...
    var draft_file = "https://s3.ca-central-1.amazonaws.com/fantaisiefootball.p-o.ca/ms_mock.csv";
      ...
      $.get(draft_file + "?now=" + Date.now(), function(txt) {
        ...
        for (var i = 9, len = lines.length - 1; i < len; i++) {
          ...
          if (participant == "P-O Trudeau" || participant == "TRUDEAU") {
            ...
            $("#header_pos_" + position).html(position + " (" + $("#val_pos_" + position + " br").lenght + ")");
          }
